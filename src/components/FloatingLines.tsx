...
type FloatingLinesProps = {
  ...
  eventSource?: HTMLElement | React.MutableRefObject<HTMLElement> | null;
};
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    // Resolve the event target - prioritize passed eventSource over the local container
    const eventTarget = eventSource ? ('current' in eventSource ? eventSource.current : eventSource) : container;
    ...
    if (interactive) {
      // Use eventTarget (the provided eventSource or container by default) instead of the DOM element
      // For precision we listen on the eventTarget but calculate bounds relative to our dom element
