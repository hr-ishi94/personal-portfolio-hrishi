        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 text-left">
            {/* <motion.div
              ...
              className="inline-flex items-center gap-2 self-start px-3.5 py-1.5 rounded-full border border-primary-teal/20 bg-primary-teal/5 text-primary-teal text-xs font-bold uppercase tracking-wider select-none"
            >
